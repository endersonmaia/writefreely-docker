...
LABEL org.opencontainers.image.source=https://github.com/endersonmaia/writefreely-docker
...
RUN git clone --depth 1 https://github.com/writefreely/writefreely --branch v0.14.0 --single-branch .
